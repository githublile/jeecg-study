...
import org.core.annotation.JeecgEntityTitle;
import org.core.common.dao.IGenericBaseCommonDao;
import org.core.common.dao.jdbc.JdbcDao;
import org.core.common.exception.BusinessException;
import org.core.common.hibernate.qbc.CriteriaQuery;
import org.core.common.hibernate.qbc.DetachedCriteriaUtil;
import org.core.common.hibernate.qbc.HqlQuery;
import org.core.common.hibernate.qbc.PageList;
import org.core.common.hibernate.qbc.PagerUtil;
import org.core.common.model.DBTable;
import org.core.common.model.json.DataGridReturn;
import org.core.util.MyBeanUtils;
import org.core.util.ToEntityUtil;
...
import org.tag.core.vo.datatable.DataTableReturn;
...
public abstract class GenericBaseCommonDao<T, PK extends Serializable>
	...
	private <T> void getProperty(Class entityName) {
		...
		for (int i = 0; i < str.length; i++) {
			...
			org.core.util.LogUtil.info(property + "---&gt;" + type);
		}
	}
